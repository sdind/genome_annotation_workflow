...
PROT_DIR=os.path.dirname(os.path.join(config['snakemake_dir_path'],"workflow/files/uniprot_sprot.fasta.gz")) + "/"
PROT_FASTA_GZ=os.path.basename(os.path.join(config['snakemake_dir_path'],"workflow/files/uniprot_sprot.fasta.gz"))
